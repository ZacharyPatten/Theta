    ...
    public class DrawStuffOtk : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            try
            {
                ...
                stmChecker = a.GetManifestResourceStream("PhysicsOpenGL.Resources.checkered.png");
                stmGround = a.GetManifestResourceStream("PhysicsOpenGL.Resources.ground.png");
                stmSky = a.GetManifestResourceStream("PhysicsOpenGL.Resources.sky.png");
                stmWood = a.GetManifestResourceStream("PhysicsOpenGL.Resources.wood.png");
                stmGrass = a.GetManifestResourceStream("PhysicsOpenGL.Resources.grass.jpeg");
            }
            catch
            {
        ...
        protected void dsGetViewPoint(out Vector<float> position, out Vector<float> angles)
        {
            position = new Vector<float>(
                view_xyz[0],
                view_xyz[1],
                view_xyz[2]);
        ...
        protected void dsDrawLine(Vector<float> _pos1, Vector<float> _pos2)
        {
            float[] pos1 = _pos1._vector;
            float[] pos2 = _pos2._vector;
        ...
        protected void dsDrawSphere(Vector<float> pos, Matrix<float> R, float radius)
        {
            float[] pos2 = pos._vector;
            float[] R2 = R._matrix;
        ...
        protected void dsDrawTriangle(Vector<float> pos, Matrix<float> R, float[] vAll, int v0, int v1, int v2, bool solid)
        {
            if (current_state != 2)
                Console.WriteLine("drawing function called outside simulation loop");
            setupDrawingMode();
        ...
        public void dsDrawTriangle(Vector<float> pos, Matrix<float> R,
                                    Vector<float> v0, Vector<float> v1,
                                    Vector<float> v2, bool solid)
        {
            setupDrawingMode();
            GL.ShadeModel(ShadingModel.Flat);
            setTransform(pos, R);
        ...
        private void drawTriangle(Vector<float> v0, Vector<float> v1,
                                   Vector<float> v2, bool solid)
        {
        ...
        private void setTransform(Vector<float> pos, Matrix<float> R)
        {
            //GLdouble
        ...
        public void dsDrawConvex(Vector<float> pos, Matrix<float> R,
        ...
        protected void dsDrawCapsule(Vector<float> pos, Matrix<float> R,
        ...
        protected void dsDrawCylinder(Vector<float> pos, Matrix<float> R, float length, float radius)
        {
            float[] pos2 = pos._vector;
            float[] R2 = R._matrix;
        ...
        protected void dsDrawBox(Vector<float> pos, Matrix<float> R, Vector<float> sides)
        {
            float[] pos2 = pos._vector;
            float[] R2 = R._matrix;
            float[] fsides = sides._vector;
