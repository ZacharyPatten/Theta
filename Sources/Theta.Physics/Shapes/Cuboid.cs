...
namespace Theta.Physics.Shapes
{
    public class Cuboid<T> : XenoScan<T>
    {
        ...
        public Cuboid() : this(Compute<T>.One, Compute<T>.One, Compute<T>.One) { }
        ...
        public Vector<T>[] Corners
        {
            get
            {
                ...
                T y_neg = Compute<T>.Subtract(this._position.Y, this._halfHeight);
                T z_neg = Compute<T>.Subtract(this._position.Z, this._halfWidth);
                T x_pos = Compute<T>.Add(this._position.X, this._halfLength);
                T y_pos = Compute<T>.Add(this._position.Y, this._halfHeight);
                T z_pos = Compute<T>.Add(this._position.Z, this._halfWidth);
