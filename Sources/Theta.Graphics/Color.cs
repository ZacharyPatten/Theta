...
namespace Theta.Graphics
{
	...
	public struct Color
	{
        ...
        public float R
        {
            ...
            set
            {
                Code.Assert<InvalidOperationException>(value < 0 || value > 1, "Setting an invalid R value of a Color (0 <= R <= 1).");
                this._r = value;
            }
        }
        ...
        public float G
        {
            ...
            set
            {
                Code.Assert<InvalidOperationException>(value < 0 || value > 1, "Setting an invalid G value of a Color (0 <= G <= 1).");
                this._g = value;
            }
        }
        ...
        public float B
        {
            ...
            set
            {
                Code.Assert<InvalidOperationException>(value < 0 || value > 1, "Setting an invalid B value of a Color (0 <= B <= 1).");
                this._b = value;
            }
        }
        ...
        public float A
        {
            ...
            set
            {
                Code.Assert<InvalidOperationException>(value < 0 || value > 1, "Setting an invalid A value of a Color (0 <= A <= 1).");
                this._a = value;
            }
        }
        ...
        {
            return new Color(
                Compute<float>.Maximum(a.R + b.R, 1f),
                Compute<float>.Maximum(a.G + b.G, 1f),
                Compute<float>.Maximum(a.B + b.B, 1f),
                Compute<float>.Maximum(a.A + b.A, 1f));
        }
        ...
        {
            return new Color(
                Compute<float>.Maximum(a.R - b.R, 0f),
                Compute<float>.Maximum(a.G - b.G, 0f),
                Compute<float>.Maximum(a.B - b.B, 0f),
                Compute<float>.Maximum(a.A - b.A, 0f));
        }
        ...
        /// <summary>Converts sRGB color values to Theta.Graphics.Color values.</summary>
        ...
        public static Color FromSrgb(float red, float green, float blue, float alpha)
        {
            ...
            {
                r = (float)Compute<float>.Power((red + 0.055f) / (1.0f + 0.055f), 2.4f);
            }
            ...
            {
                g = (float)Compute<float>.Power((green + 0.055f) / (1.0f + 0.055f), 2.4f);
            }
            ...
            {
                b = (float)Compute<float>.Power((blue + 0.055f) / (1.0f + 0.055f), 2.4f);
            }
        ...
        /// <summary>Converts Theta.Graphics.Color values sRGB values.</summary>
        /// <param name="color">The Theta.Graphics.Color to convert.</param>
        /// <param name="red">The sRGB red component.</param>
        /// <param name="green">The sRGB green component.</param>
        /// <param name="blue">The sRGB blue component.</param>
        /// <param name="alpha">The sRGB alpha component.</param>
        ...
        public static void ToSrgb(Color color, out float red, out float green, out float blue, out float alpha)
        {
            ...
            {
                red = (1.0f + 0.055f) * (float)Compute<float>.Power(color.R, 1.0f / 2.4f) - 0.055f;
            }
            ...
            {
                green = (1.0f + 0.055f) * (float)Compute<float>.Power(color.G, 1.0f / 2.4f) - 0.055f;
            }
            ...
            {
                blue = (1.0f + 0.055f) * (float)Compute<float>.Power(color.B, 1.0f / 2.4f) - 0.055f;
            }
        ...
        /// <summary>Converts HSL color values to Theta.Graphics.Color values.</summary>
        ...
        public static Color FromHsl(float hue, float saturation, float lightness, float alpha)
        {
            ...
            var C = (1.0f - Compute<float>.AbsoluteValue(2.0f * lightness - 1.0f)) * saturation;

            var h = hue / 60.0f;
            var X = C * (1.0f - Compute<float>.AbsoluteValue(h % 2.0f - 1.0f));
        ...
        /// <summary>Converts Theta.Graphics.Color value to HSL color values.</summary>
        /// <param name="color">The Theta.Graphics.Color value to convert.</param>
        /// <param name="hue">The HSL hue component.</param>
        /// <param name="saturation">The HSL hue saturation.</param>
        /// <param name="lightness">The HSL hue lightness.</param>
        /// <param name="alpha">The HSL hue alpha.</param>
        ...
        {
            var M = Compute<float>.Maximum(color.R, Compute<float>.Maximum(color.G, color.B));
            var m = Compute<float>.Minimum(color.R, Compute<float>.Minimum(color.G, color.B));
            var C = M - m;
        ...
        /// <summary>Converts HSV color values to Theta.Graphics.Color values.</summary>
        ...
        /// <summary>Converts Theta.Graphics.Color values to HSV color values.</summary>
        /// <param name="color">The Theta.Graphics.Color value to convert.</param>
        /// <param name="hue">The HSV hue component.</param>
        /// <param name="saturation">The HSV saturation component.</param>
        /// <param name="value">The HSV value component.</param>
        ...
        /// <summary>Converts XYZ color values to Theta.Graphics.Color values.</summary>
        ...
        /// <summary>Converts Theta.Graphics.Color values to XYZ color values.</summary>
        /// <param name="color">The Theta.Graphics.Color value to convert.</param>
        /// <param name="x">The XYZ x component.</param>
        /// <param name="y">The XYZ y component.</param>
        /// <param name="z">The XYZ z component.</param>
        ...
        /// <summary>Converts YCbCr color values to Theta.Graphics.Color values.</summary>
        ...
        {
            Code.Assert<ArgumentOutOfRangeException>(luma < 0f || luma > 1f, "The luma value is out of bounds (0-255).");
            Code.Assert<ArgumentOutOfRangeException>(blueDifferenceChroma < -0.5 || blueDifferenceChroma > 0.5f, "The blueDifferenceChroma value is out of bounds (-0.5 to 0.5f).");
            Code.Assert<ArgumentOutOfRangeException>(redDifferenceChroma < -0.5f || redDifferenceChroma > 0.5f, "The redDifferenceChroma value is out of bounds (0-255).");
            Code.Assert<ArgumentOutOfRangeException>(alpha < 0f || alpha > 1f, "The alpha value is out of bounds (0-255).");
        ...
        /// <summary>Converts Theta.Graphics.Color values to a YCbCr color values.</summary>
        /// <param name="color">The Theta.Graphics.Color value to be converted.</param>
        /// <param name="luma">The YCbCr luma component (0.0 to 1.0).</param>
        /// <param name="blueDifferenceChroma">The YCbCr blue-difference chroma component (-0.5 to 0.5).</param>
        /// <param name="redDifferenceChroma">The YCbCr red-difference chroma component (-0.5 to 0.5).</param>
        /// <param name="alpha">The YCbCr alpha component.</param>
        ...
        /// <summary>Converts HCY color values to Theta.Graphics.Color values.</summary>
        ...
        {
            Code.Assert<ArgumentOutOfRangeException>(hue < 0f || hue > 1f, "The hue value is out of bounds (0 to 1).");
            Code.Assert<ArgumentOutOfRangeException>(chroma < 0f || chroma > 1f, "The chroma value is out of bounds (0 to 1).");
            Code.Assert<ArgumentOutOfRangeException>(luminance < 0f || luminance > 1f, "The luminance value is out of bounds (0 to 1).");
            Code.Assert<ArgumentOutOfRangeException>(alpha < 0f || alpha > 1f, "The alpha value is out of bounds (0 to 1).");
        ...
        /// <summary>Converts Theta.Graphics.Color values to HCY color values.</summary>
        /// <param name="color">The Theta.Graphics.Color value to convert.</param>
        /// <param name="hue">The HCY hue component.</param>
        /// <param name="chroma">The HCY chroma component.</param>
        /// <param name="luminance">The HCY luminance component.</param>
        ...
        /// <summary>Converts RGBA-255 color values to Theta.Graphics.Color values.</summary>
		...
		{
            Code.Assert<ArgumentOutOfRangeException>(red < 0 || red > 255, "The red value is out of bounds (0 to 255).");
            Code.Assert<ArgumentOutOfRangeException>(green < 0 || green > 255, "The green value is out of bounds (0 to 255).");
            Code.Assert<ArgumentOutOfRangeException>(blue < 0 || blue > 255, "The blue value is out of bounds (0 to 255).");
            Code.Assert<ArgumentOutOfRangeException>(alpha < 0 || alpha > 255, "The alpha value is out of bounds (0 to 255).");

			return new Color((float)red / 255F, (float)green / 255F, (float)blue / 255F, (float)alpha / 255F);
		}

        /// <summary>Converts Theta.Graphics.Color values to RGBA-255 color values.</summary>
        /// <param name="color">The Theta.Graphics.Color value to convert.</param>
        /// <param name="red">The RGBA-255 red component.</param>
        /// <param name="green">The RGBA-255 green component.</param>
        /// <param name="blue">The RGBA-255 blue component.</param>
