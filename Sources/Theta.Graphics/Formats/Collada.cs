        ...
        public static Model Parse(string contents)
        {
            ...
            for (int i = 0; i < effectorJointCounts.Length; i++)
            {
                ...
                if (count > maxJointEffectors) // too many effectors (select largest weights)
                {
                    ...
                    for (int j = 0; j < maxJointEffectors; j++)
                    {
                        limitedJointAndWeightsPerVertex[j]._2 = Compute<float>.Minimum(limitedJointAndWeightsPerVertex[j]._2 / totalWeightPerMaxEffectors, 1f);
                    }
            ...
            JOINTIDSDATA = jointIds; // DELETE ME
            JOINTWEIGHTSDATA = jointWeights; // DELETE ME
            ...
            POSITIONDATA = positions; // DELETE ME
            ...
            TEXTURECOORDINATEDATA = textureCoordinates; // DELETE ME
