...
namespace Theta.Mathematics
{
	...
	public static class Symbolics<T>
	{
				...
				methodCallExpression_to_node =
                    (MethodCallExpression methodCallExpression) =>
					{
                        ...
                        if (method == null || method.DeclaringType != typeof(Compute<T>))
                            throw new System.ArithmeticException("Invalid syntax parse (only members of Theta.MathematicsCompute<T> allowed): " + methodCallExpression);
        ...
        internal static OperationType ShallowOperationClone<OperationType>(OperationType operation) where OperationType : Operation
        {
            ...
            {
                throw new System.ArithmeticException("There was a bug in the Theta framework when cloning a node.", exception);
            }
        }
