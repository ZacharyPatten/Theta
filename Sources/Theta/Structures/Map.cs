namespace Theta.Structures
{
		...
		Structure.Hashing<K>
	{
		...
		public MapHashLinked() : this(Theta.Equate.Default, Theta.Hash.Default) { }

		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public MapHashLinked(int expectedCount) : this(Theta.Equate.Default, Theta.Hash.Default, expectedCount) { }

		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public MapHashLinked(Equate<K> equate, Hash<K> hash) : this(Theta.Equate.Default, Theta.Hash.Default, 0) { }
		...
		Structure.Hashing<K>
	{
		...
		public MapHashArray() : this(Theta.Equate.Default, Theta.Hash.Default) { }

		public MapHashArray(int expectedCount) : this(Theta.Equate.Default, Theta.Hash.Default) { }
