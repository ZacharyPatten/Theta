namespace Theta.Structures
{
		...
		Structure.Hashing<T>
	{
        ...
        public SetHashList() : this(Theta.Equate.Default, Theta.Hash.Default) { }
		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
        public SetHashList(int expectedCount) : this(Theta.Equate.Default, Theta.Hash.Default, expectedCount) { }
		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
        public SetHashList(Equate<T> equate, Hash<T> hash) : this(Theta.Equate.Default, Theta.Hash.Default, 0) { }
		/// <summary>Constructs a new hash table instance.</summary>
		...
		{
			Remove_private(key);
			if (this._count > Theta.Hash.TableSizes[0] && _count < this._table.Length * _minLoadFactor)
		...
		public void Clear()
		{
			_table = new Node[Theta.Hash.TableSizes[0]];
			_count = 0;
		}
		#endregion
		...
		{
			for (int i = 0; i < Theta.Hash.TableSizes.Length; i++)
				if (this._table.Length < Theta.Hash.TableSizes[i])
					return Theta.Hash.TableSizes[i];
			return Theta.Hash.TableSizes[Theta.Hash.TableSizes[Theta.Hash.TableSizes.Length - 1]];
		}
		#endregion
		#region internal int GetSmallerSize()
		internal int GetSmallerSize()
		{
			for (int i = Theta.Hash.TableSizes.Length - 1; i > -1; i--)
				if (this._table.Length > Theta.Hash.TableSizes[i])
					return Theta.Hash.TableSizes[i];
			return Theta.Hash.TableSizes[0];
		}
		#endregion
		...
		Structure.Hashing<T>
	{
		...
		public SetHashArray() : this(Theta.Equate.Default, Theta.Hash.Default) { }
		#endregion
		...
		where STRUCTURE : class, Structure<T>, Structure.Addable<T>, Structure.Removable<T>, Structure.Auditable<T>
	{
		...
		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public Set() : this(Theta.Equate.Default, Theta.Hash.Default) { }
		#endregion
		#region public Set(Construct<T> constructor, int expectedCount)
		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public Set(int expectedCount) : this(Theta.Equate.Default, Theta.Hash.Default, expectedCount) { }
		#endregion
		#region public Set(Construct<T> constructor, Equate<T> equate, Hash<T> hash)
		/// <summary>Constructs a new hash table instance.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public Set(Equate<T> equate, Hash<T> hash) : this(Theta.Equate.Default, Theta.Hash.Default, 0) { }
		#endregion
		...
		public Set(Equate<T> equate, Hash<T> hash, int expectedCount)
		{
			...
			{
				this._table = new STRUCTURE[Theta.Hash.TableSizes[0]];
			}
			this._equate = equate;
			this._hash = hash;
			this._count = 0;
		...
		public void Clear()
		{
			_table = new STRUCTURE[Theta.Hash.TableSizes[0]];
			_count = 0;
		}
		#endregion
		#region public void Stepper(Step<T> function)
