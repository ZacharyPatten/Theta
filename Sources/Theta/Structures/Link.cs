//------------------------------------------------------------------------------
// <auto-generated>
//	  This code was generated from a T4 Text Template. See the template
//		"Omnitree.tt" for modification.
//
...
namespace Theta.Structures
{
	...
	public class Link<T1> : Link
	{
		...
		{			if (function(this._1) == StepStatus.Break)
				return StepStatus.Break;			return StepStatus.Continue;
		}
	...
	public class Link<T1, T2> : Link
	{
		...
		System.Collections.IEnumerator
			System.Collections.IEnumerable.GetEnumerator()
		{			yield return this._1;			yield return this._2;		}
		...
		public	bool Contains(object item, Compare<object> compare)
		{			if (compare(this._1, item) == Comparison.Equal)
				return true;			if (compare(this._2, item) == Comparison.Equal)
				return true;			return false;
		}
		...
		public bool Contains<Key>(Key key, Compare<object, Key> compare)
		{			if (compare(this._1, key) == Comparison.Equal)
				return true;			if (compare(this._2, key) == Comparison.Equal)
				return true;			return false;
		}
		...
		/// <param name="function">The delegate to invoke on each item in the structure.</param>
		public void Stepper(Step<object> function)
		{			function(this._1);			function(this._2);		}
		...
		public	StepStatus Stepper(StepBreak<object> function)
		{			if (function(this._1) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._2) == StepStatus.Break)
				return StepStatus.Break;			return StepStatus.Continue;
		}
	...
	public class Link<T1, T2, T3> : Link
	{
		...
		{			this.__1 = _1;			this.__2 = _2;			this.__3 = _3;		}
		...
		System.Collections.IEnumerator
			System.Collections.IEnumerable.GetEnumerator()
		{			yield return this._1;			yield return this._2;			yield return this._3;		}
		...
		{			if (compare(this._1, item) == Comparison.Equal)
				return true;			if (compare(this._2, item) == Comparison.Equal)
				return true;			if (compare(this._3, item) == Comparison.Equal)
				return true;			return false;
		}
		...
		{			if (compare(this._1, key) == Comparison.Equal)
				return true;			if (compare(this._2, key) == Comparison.Equal)
				return true;			if (compare(this._3, key) == Comparison.Equal)
				return true;			return false;
		}
		...
		/// <param name="function">The delegate to invoke on each item in the structure.</param>
		public void Stepper(Step<object> function)
		{			function(this._1);			function(this._2);			function(this._3);		}
		...
		{			if (function(this._1) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._2) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._3) == StepStatus.Break)
				return StepStatus.Break;			return StepStatus.Continue;
		}
	...
	public class Link<T1, T2, T3, T4> : Link
	{
		...
		{			this.__1 = _1;			this.__2 = _2;			this.__3 = _3;			this.__4 = _4;		}
		...
		System.Collections.IEnumerator
			System.Collections.IEnumerable.GetEnumerator()
		{			yield return this._1;			yield return this._2;			yield return this._3;			yield return this._4;		}
		...
		{			if (compare(this._1, item) == Comparison.Equal)
				return true;			if (compare(this._2, item) == Comparison.Equal)
				return true;			if (compare(this._3, item) == Comparison.Equal)
				return true;			if (compare(this._4, item) == Comparison.Equal)
				return true;			return false;
		}
		...
		{			if (compare(this._1, key) == Comparison.Equal)
				return true;			if (compare(this._2, key) == Comparison.Equal)
				return true;			if (compare(this._3, key) == Comparison.Equal)
				return true;			if (compare(this._4, key) == Comparison.Equal)
				return true;			return false;
		}
		...
		/// <param name="function">The delegate to invoke on each item in the structure.</param>
		public void Stepper(Step<object> function)
		{			function(this._1);			function(this._2);			function(this._3);			function(this._4);		}
		...
		{			if (function(this._1) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._2) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._3) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._4) == StepStatus.Break)
				return StepStatus.Break;			return StepStatus.Continue;
		}
	...
	public class Link<T1, T2, T3, T4, T5> : Link
	{
		...
		{			this.__1 = _1;			this.__2 = _2;			this.__3 = _3;			this.__4 = _4;			this.__5 = _5;		}
		...
		System.Collections.IEnumerator
			System.Collections.IEnumerable.GetEnumerator()
		{			yield return this._1;			yield return this._2;			yield return this._3;			yield return this._4;			yield return this._5;		}
		...
		{			if (compare(this._1, item) == Comparison.Equal)
				...
				return true;			if (compare(this._3, item) == Comparison.Equal)
				return true;			if (compare(this._4, item) == Comparison.Equal)
				return true;			if (compare(this._5, item) == Comparison.Equal)
				return true;			return false;
		}
		...
		{			if (compare(this._1, key) == Comparison.Equal)
				...
				return true;			if (compare(this._3, key) == Comparison.Equal)
				return true;			if (compare(this._4, key) == Comparison.Equal)
				return true;			if (compare(this._5, key) == Comparison.Equal)
				return true;			return false;
		}
		...
		/// <param name="function">The delegate to invoke on each item in the structure.</param>
		public void Stepper(Step<object> function)
		{			function(this._1);			function(this._2);			function(this._3);			function(this._4);			function(this._5);		}
		...
		{			if (function(this._1) == StepStatus.Break)
				...
				return StepStatus.Break;			if (function(this._3) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._4) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._5) == StepStatus.Break)
				return StepStatus.Break;			return StepStatus.Continue;
		}
	...
	public class Link<T1, T2, T3, T4, T5, T6> : Link
	{
		...
		{			this.__1 = _1;			this.__2 = _2;			this.__3 = _3;			this.__4 = _4;			this.__5 = _5;			this.__6 = _6;		}
		...
		System.Collections.IEnumerator
			System.Collections.IEnumerable.GetEnumerator()
		{			yield return this._1;			yield return this._2;			yield return this._3;			yield return this._4;			yield return this._5;			yield return this._6;		}
		...
		{			if (compare(this._1, item) == Comparison.Equal)
				...
				return true;			if (compare(this._4, item) == Comparison.Equal)
				return true;			if (compare(this._5, item) == Comparison.Equal)
				return true;			if (compare(this._6, item) == Comparison.Equal)
				return true;			return false;
		}
		...
		{			if (compare(this._1, key) == Comparison.Equal)
				...
				return true;			if (compare(this._4, key) == Comparison.Equal)
				return true;			if (compare(this._5, key) == Comparison.Equal)
				return true;			if (compare(this._6, key) == Comparison.Equal)
				return true;			return false;
		}
		...
		/// <param name="function">The delegate to invoke on each item in the structure.</param>
		public void Stepper(Step<object> function)
		{			function(this._1);			function(this._2);			function(this._3);			function(this._4);			function(this._5);			function(this._6);		}
		...
		{			if (function(this._1) == StepStatus.Break)
				...
				return StepStatus.Break;			if (function(this._4) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._5) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._6) == StepStatus.Break)
				return StepStatus.Break;			return StepStatus.Continue;
		}
	...
	public class Link<T1, T2, T3, T4, T5, T6, T7> : Link
	{
		...
		{			this.__1 = _1;			this.__2 = _2;			this.__3 = _3;			this.__4 = _4;			this.__5 = _5;			this.__6 = _6;			this.__7 = _7;		}
		...
		System.Collections.IEnumerator
			System.Collections.IEnumerable.GetEnumerator()
		{			yield return this._1;			yield return this._2;			yield return this._3;			yield return this._4;			yield return this._5;			yield return this._6;			yield return this._7;		}
		...
		{			if (compare(this._1, item) == Comparison.Equal)
				...
				return true;			if (compare(this._5, item) == Comparison.Equal)
				return true;			if (compare(this._6, item) == Comparison.Equal)
				return true;			if (compare(this._7, item) == Comparison.Equal)
				return true;			return false;
		}
		...
		{			if (compare(this._1, key) == Comparison.Equal)
				...
				return true;			if (compare(this._5, key) == Comparison.Equal)
				return true;			if (compare(this._6, key) == Comparison.Equal)
				return true;			if (compare(this._7, key) == Comparison.Equal)
				return true;			return false;
		}
		...
		/// <param name="function">The delegate to invoke on each item in the structure.</param>
		public void Stepper(Step<object> function)
		{			function(this._1);			function(this._2);			function(this._3);			function(this._4);			function(this._5);			function(this._6);			function(this._7);		}
		...
		{			if (function(this._1) == StepStatus.Break)
				...
				return StepStatus.Break;			if (function(this._5) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._6) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._7) == StepStatus.Break)
				return StepStatus.Break;			return StepStatus.Continue;
		}
	...
	/// <typeparam name="T6">The type of #6 element in the link.</typeparam>
	/// <typeparam name="T7">The type of #7 element in the link.</typeparam>
	/// <typeparam name="T8">The type of #8 element in the link.</typeparam>
	[System.Serializable]
	public class Link<T1, T2, T3, T4, T5, T6, T7, T8> : Link
	{
		// Fields
		protected T1 __1;
		protected T2 __2;
		...
		/// <param name="_6">The #6 item to be linked.</param>
		/// <param name="_7">The #7 item to be linked.</param>
		/// <param name="_8">The #8 item to be linked.</param>
		/// <remarks>Runtime: O(1).</remarks>
		public Link(T1 _1, T2 _2, T3 _3, T4 _4, T5 _5, T6 _6, T7 _7, T8 _8)
		{			this.__1 = _1;			this.__2 = _2;			this.__3 = _3;			this.__4 = _4;			this.__5 = _5;			this.__6 = _6;			this.__7 = _7;			this.__8 = _8;		}
		...
		/// <summary>The #8 item in the link.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public T8 _8 { get { return this.__8; } set { this.__8 = value; } }
		...
		System.Collections.IEnumerator
			System.Collections.IEnumerable.GetEnumerator()
		{			yield return this._1;			yield return this._2;			yield return this._3;			yield return this._4;			yield return this._5;			yield return this._6;			yield return this._7;			yield return this._8;		}
		...
		{			if (compare(this._1, item) == Comparison.Equal)
				...
				return true;			if (compare(this._6, item) == Comparison.Equal)
				return true;			if (compare(this._7, item) == Comparison.Equal)
				return true;			if (compare(this._8, item) == Comparison.Equal)
				return true;			return false;
		}
		...
		{			if (compare(this._1, key) == Comparison.Equal)
				...
				return true;			if (compare(this._6, key) == Comparison.Equal)
				return true;			if (compare(this._7, key) == Comparison.Equal)
				return true;			if (compare(this._8, key) == Comparison.Equal)
				return true;			return false;
		}
		...
		/// <param name="function">The delegate to invoke on each item in the structure.</param>
		public void Stepper(Step<object> function)
		{			function(this._1);			function(this._2);			function(this._3);			function(this._4);			function(this._5);			function(this._6);			function(this._7);			function(this._8);		}
		...
		{			if (function(this._1) == StepStatus.Break)
				...
				return StepStatus.Break;			if (function(this._6) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._7) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._8) == StepStatus.Break)
				return StepStatus.Break;			return StepStatus.Continue;
		}
		...
		public	Structure<object> Clone()
		{
			return new Link<T1, T2, T3, T4, T5, T6, T7, T8>((T1)this._1, this._2, this._3, this._4, this._5, this._6, this._7, this._8);
		}
		...
		public override bool Equals(object obj)
		{
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8>)._1.Equals(this._1))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8>)._2.Equals(this._2))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8>)._3.Equals(this._3))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8>)._4.Equals(this._4))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8>)._5.Equals(this._5))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8>)._6.Equals(this._6))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8>)._7.Equals(this._7))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8>)._8.Equals(this._8))
				return false;
			return true;
		}
	...
	/// <typeparam name="T8">The type of #8 element in the link.</typeparam>
	[System.Serializable]
	public struct LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8> : Link
	{
		// Fields
		private T1 __1;
		private T2 __2;
		...
		/// <param name="_8">The #8 item to be linked.</param>
		/// <remarks>Runtime: O(1).</remarks>
		public LinkStruct(T1 _1, T2 _2, T3 _3, T4 _4, T5 _5, T6 _6, T7 _7, T8 _8)
		{			this.__1 = _1;			this.__2 = _2;			this.__3 = _3;			this.__4 = _4;			this.__5 = _5;			this.__6 = _6;			this.__7 = _7;			this.__8 = _8;		}
		...
		public Structure<object> Clone()
		{
			return new LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8>((T1)this._1, this._2, this._3, this._4, this._5, this._6, this._7, this._8);
		}
		...
		public override bool Equals(object obj)
		{
				if (!(obj is LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8>))
					 return false;

				LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8> linkStruct = (LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8>)obj;
			if (!linkStruct._1.Equals(this._1))
				return false;
			if (!linkStruct._2.Equals(this._2))
				return false;
			...
			if (!linkStruct._7.Equals(this._7))
				return false;
			if (!linkStruct._8.Equals(this._8))
				return false;
			return true;
		}
	...
	/// <typeparam name="T7">The type of #7 element in the link.</typeparam>
	/// <typeparam name="T8">The type of #8 element in the link.</typeparam>
	/// <typeparam name="T9">The type of #9 element in the link.</typeparam>
	[System.Serializable]
	public class Link<T1, T2, T3, T4, T5, T6, T7, T8, T9> : Link
	{
		// Fields
		protected T1 __1;
		protected T2 __2;
		...
		/// <param name="_7">The #7 item to be linked.</param>
		/// <param name="_8">The #8 item to be linked.</param>
		/// <param name="_9">The #9 item to be linked.</param>
		/// <remarks>Runtime: O(1).</remarks>
		public Link(T1 _1, T2 _2, T3 _3, T4 _4, T5 _5, T6 _6, T7 _7, T8 _8, T9 _9)
		{			this.__1 = _1;			this.__2 = _2;			this.__3 = _3;			this.__4 = _4;			this.__5 = _5;			this.__6 = _6;			this.__7 = _7;			this.__8 = _8;			this.__9 = _9;		}
		...
		/// <summary>The #9 item in the link.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public T9 _9 { get { return this.__9; } set { this.__9 = value; } }
		...
		System.Collections.IEnumerator
			System.Collections.IEnumerable.GetEnumerator()
		{			yield return this._1;			yield return this._2;			yield return this._3;			yield return this._4;			yield return this._5;			yield return this._6;			yield return this._7;			yield return this._8;			yield return this._9;		}
		...
		{			if (compare(this._1, item) == Comparison.Equal)
				...
				return true;			if (compare(this._7, item) == Comparison.Equal)
				return true;			if (compare(this._8, item) == Comparison.Equal)
				return true;			if (compare(this._9, item) == Comparison.Equal)
				return true;			return false;
		}
		...
		{			if (compare(this._1, key) == Comparison.Equal)
				...
				return true;			if (compare(this._7, key) == Comparison.Equal)
				return true;			if (compare(this._8, key) == Comparison.Equal)
				return true;			if (compare(this._9, key) == Comparison.Equal)
				return true;			return false;
		}
		...
		/// <param name="function">The delegate to invoke on each item in the structure.</param>
		public void Stepper(Step<object> function)
		{			function(this._1);			function(this._2);			function(this._3);			function(this._4);			function(this._5);			function(this._6);			function(this._7);			function(this._8);			function(this._9);		}
		...
		{			if (function(this._1) == StepStatus.Break)
				...
				return StepStatus.Break;			if (function(this._7) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._8) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._9) == StepStatus.Break)
				return StepStatus.Break;			return StepStatus.Continue;
		}
		...
		public	Structure<object> Clone()
		{
			return new Link<T1, T2, T3, T4, T5, T6, T7, T8, T9>((T1)this._1, this._2, this._3, this._4, this._5, this._6, this._7, this._8, this._9);
		}
		...
		public override bool Equals(object obj)
		{
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9>)._1.Equals(this._1))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9>)._2.Equals(this._2))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9>)._3.Equals(this._3))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9>)._4.Equals(this._4))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9>)._5.Equals(this._5))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9>)._6.Equals(this._6))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9>)._7.Equals(this._7))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9>)._8.Equals(this._8))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9>)._9.Equals(this._9))
				return false;
			return true;
		}
	...
	/// <typeparam name="T9">The type of #9 element in the link.</typeparam>
	[System.Serializable]
	public struct LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8, T9> : Link
	{
		// Fields
		private T1 __1;
		private T2 __2;
		...
		/// <param name="_9">The #9 item to be linked.</param>
		/// <remarks>Runtime: O(1).</remarks>
		public LinkStruct(T1 _1, T2 _2, T3 _3, T4 _4, T5 _5, T6 _6, T7 _7, T8 _8, T9 _9)
		{			this.__1 = _1;			this.__2 = _2;			this.__3 = _3;			this.__4 = _4;			this.__5 = _5;			this.__6 = _6;			this.__7 = _7;			this.__8 = _8;			this.__9 = _9;		}
		...
		public Structure<object> Clone()
		{
			return new LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8, T9>((T1)this._1, this._2, this._3, this._4, this._5, this._6, this._7, this._8, this._9);
		}
		...
		public override bool Equals(object obj)
		{
				if (!(obj is LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8, T9>))
					 return false;

				LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8, T9> linkStruct = (LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8, T9>)obj;
			if (!linkStruct._1.Equals(this._1))
				return false;
			if (!linkStruct._2.Equals(this._2))
				return false;
			...
			if (!linkStruct._8.Equals(this._8))
				return false;
			if (!linkStruct._9.Equals(this._9))
				return false;
			return true;
		}
	...
	/// <typeparam name="T8">The type of #8 element in the link.</typeparam>
	/// <typeparam name="T9">The type of #9 element in the link.</typeparam>
	/// <typeparam name="T10">The type of #10 element in the link.</typeparam>
	[System.Serializable]
	public class Link<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : Link
	{
		// Fields
		protected T1 __1;
		protected T2 __2;
		...
		/// <param name="_8">The #8 item to be linked.</param>
		/// <param name="_9">The #9 item to be linked.</param>
		/// <param name="_10">The #10 item to be linked.</param>
		/// <remarks>Runtime: O(1).</remarks>
		public Link(T1 _1, T2 _2, T3 _3, T4 _4, T5 _5, T6 _6, T7 _7, T8 _8, T9 _9, T10 _10)
		{			this.__1 = _1;			this.__2 = _2;			this.__3 = _3;			this.__4 = _4;			this.__5 = _5;			this.__6 = _6;			this.__7 = _7;			this.__8 = _8;			this.__9 = _9;			this.__10 = _10;		}
		...
		/// <summary>The #10 item in the link.</summary>
		/// <remarks>Runtime: O(1).</remarks>
		public T10 _10 { get { return this.__10; } set { this.__10 = value; } }
		...
		System.Collections.IEnumerator
			System.Collections.IEnumerable.GetEnumerator()
		{			yield return this._1;			yield return this._2;			yield return this._3;			yield return this._4;			yield return this._5;			yield return this._6;			yield return this._7;			yield return this._8;			yield return this._9;			yield return this._10;		}
		...
		{			if (compare(this._1, item) == Comparison.Equal)
				...
				return true;			if (compare(this._8, item) == Comparison.Equal)
				return true;			if (compare(this._9, item) == Comparison.Equal)
				return true;			if (compare(this._10, item) == Comparison.Equal)
				return true;			return false;
		}
		...
		{			if (compare(this._1, key) == Comparison.Equal)
				...
				return true;			if (compare(this._8, key) == Comparison.Equal)
				return true;			if (compare(this._9, key) == Comparison.Equal)
				return true;			if (compare(this._10, key) == Comparison.Equal)
				return true;			return false;
		}
		...
		/// <param name="function">The delegate to invoke on each item in the structure.</param>
		public void Stepper(Step<object> function)
		{			function(this._1);			function(this._2);			function(this._3);			function(this._4);			function(this._5);			function(this._6);			function(this._7);			function(this._8);			function(this._9);			function(this._10);		}
		...
		{			if (function(this._1) == StepStatus.Break)
				...
				return StepStatus.Break;			if (function(this._8) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._9) == StepStatus.Break)
				return StepStatus.Break;			if (function(this._10) == StepStatus.Break)
				return StepStatus.Break;			return StepStatus.Continue;
		}
		...
		public	Structure<object> Clone()
		{
			return new Link<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>((T1)this._1, this._2, this._3, this._4, this._5, this._6, this._7, this._8, this._9, this._10);
		}
		...
		public override int GetHashCode()
		{
			return this._1.GetHashCode()
				...
				^ this._8.GetHashCode()
				^ this._9.GetHashCode()
				^ this._10.GetHashCode();
		}

		public override bool Equals(object obj)
		{
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>)._1.Equals(this._1))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>)._2.Equals(this._2))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>)._3.Equals(this._3))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>)._4.Equals(this._4))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>)._5.Equals(this._5))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>)._6.Equals(this._6))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>)._7.Equals(this._7))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>)._8.Equals(this._8))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>)._9.Equals(this._9))
				return false;
			if (!(obj as Link<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>)._10.Equals(this._10))
				return false;
			return true;
		}
	...
	/// <typeparam name="T10">The type of #10 element in the link.</typeparam>
	[System.Serializable]
	public struct LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : Link
	{
		// Fields
		private T1 __1;
		private T2 __2;
		...
		/// <param name="_10">The #10 item to be linked.</param>
		/// <remarks>Runtime: O(1).</remarks>
		public LinkStruct(T1 _1, T2 _2, T3 _3, T4 _4, T5 _5, T6 _6, T7 _7, T8 _8, T9 _9, T10 _10)
		{			this.__1 = _1;			this.__2 = _2;			this.__3 = _3;			this.__4 = _4;			this.__5 = _5;			this.__6 = _6;			this.__7 = _7;			this.__8 = _8;			this.__9 = _9;			this.__10 = _10;		}
		...
		public Structure<object> Clone()
		{
			return new LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>((T1)this._1, this._2, this._3, this._4, this._5, this._6, this._7, this._8, this._9, this._10);
		}
		...
		public override bool Equals(object obj)
		{
				if (!(obj is LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>))
					 return false;

				LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> linkStruct = (LinkStruct<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>)obj;
			if (!linkStruct._1.Equals(this._1))
				return false;
			if (!linkStruct._2.Equals(this._2))
				return false;
			...
			if (!linkStruct._9.Equals(this._9))
				return false;
			if (!linkStruct._10.Equals(this._10))
				return false;
			return true;
		}
