...
namespace Theta.Structures
{
	...
	public class Link<T1, T2, T3, T4, T5, T6, T7, T8> : Link
	{
		...
		public	bool Contains(object item, Compare<object> compare)
		{
			...
			if (compare(this._7, item) == Comparison.Equal)
				return true;
			if (compare(this._8, item) == Comparison.Equal)
				return true;
			return false;
		}
		...
		public bool Contains<Key>(Key key, Compare<object, Key> compare)
		{
			...
			if (compare(this._7, key) == Comparison.Equal)
				return true;
			if (compare(this._8, key) == Comparison.Equal)
				return true;
			return false;
		}
		...
		public	StepStatus Stepper(StepBreak<object> function)
		{
			...
			if (function(this._7) == StepStatus.Break)
				return StepStatus.Break;
			if (function(this._8) == StepStatus.Break)
				return StepStatus.Break;
			return StepStatus.Continue;
		}
	...
	public class Link<T1, T2, T3, T4, T5, T6, T7, T8, T9> : Link
	{
		...
		public	bool Contains(object item, Compare<object> compare)
		{
			...
			if (compare(this._8, item) == Comparison.Equal)
				return true;
			if (compare(this._9, item) == Comparison.Equal)
				return true;
			return false;
		}
		...
		public bool Contains<Key>(Key key, Compare<object, Key> compare)
		{
			...
			if (compare(this._8, key) == Comparison.Equal)
				return true;
			if (compare(this._9, key) == Comparison.Equal)
				return true;
			return false;
		}
		...
		public	StepStatus Stepper(StepBreak<object> function)
		{
			...
			if (function(this._8) == StepStatus.Break)
				return StepStatus.Break;
			if (function(this._9) == StepStatus.Break)
				return StepStatus.Break;
			return StepStatus.Continue;
		}
	...
	public class Link<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : Link
	{
		...
		public	bool Contains(object item, Compare<object> compare)
		{
			...
			if (compare(this._9, item) == Comparison.Equal)
				return true;
			if (compare(this._10, item) == Comparison.Equal)
				return true;
			return false;
		}
		...
		public bool Contains<Key>(Key key, Compare<object, Key> compare)
		{
			...
			if (compare(this._9, key) == Comparison.Equal)
				return true;
			if (compare(this._10, key) == Comparison.Equal)
				return true;
			return false;
		}
		...
		public	StepStatus Stepper(StepBreak<object> function)
		{
			...
			if (function(this._9) == StepStatus.Break)
				return StepStatus.Break;
			if (function(this._10) == StepStatus.Break)
				return StepStatus.Break;
			return StepStatus.Continue;
		}
